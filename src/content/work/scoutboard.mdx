...
summary: A realtime marketplace for buying and selling small businesses, built in three weeks of evenings.
stack:
  - NestJS
  - MongoDB
  - Redis
...
<Figure
  ...
  height="885"
  breakout
  alt="The ScoutBoard marketplace: a grid of business listing cards, each with a name, industry, price and offer count, under the heading 'Own a business you'll love running.'"
...
<Figure
  ...
  height="888"
  breakout
  alt="A ScoutBoard listing for Tito's Grill and Resto at $3,000,000, its offers list on the left and an AI analysis panel on the right marking it overpriced, with a $1.8M–$2.2M fair-value range, reasoning, and a suggested opening offer."
