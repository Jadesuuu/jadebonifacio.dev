...
<Figure
  ...
  breakout
  ratio="16/9"
  label="Listings table — sortable, filterable, with live offer counts"
  caption="The listings table. Offer counts update in realtime as offers land."
/>
...
<Figure
  label="Listing detail — offers appearing live as they are posted"
  caption="Open two windows, post an offer in one, and watch it land in the other."
/>
