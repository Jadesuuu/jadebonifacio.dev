...
<Figure
  ...
  breakout
  ratio="16/9"
  label="Home map — pins in dream, visited and revisited states"
  caption="The shared map. Every pin is a place one of us wanted to go."
/>
...
<Figure
  label="Pin detail — visit history with photos and notes"
  caption="A pin that has flipped from dream to memory, with its visit log."
/>
...
<Figure
  breakout
  label="The four map themes — Dream, Night, Galaxy, Paper"
  caption="Four themes on CSS custom properties. The Galaxy theme uses a real starfield texture."
/>
